...
- Data backend: `cloud_firestore` (primary) — schema in `docs/db/zenna_mind_database_design.md`
- Auth: `firebase_auth`
...
- Data backend = Cloud Firestore. DataSources are `*_firestore_datasource.dart` using `cloud_firestore`. Cite the Firestore path from `docs/db/zenna_mind_database_design.md` for every read.
